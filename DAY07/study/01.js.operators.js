...
// 객체인 유형
console.log('types.num.constructor:', types.num.constructor === Number); //true
console.log('types.str.constructor:', types.str.constructor === String); //true
console.log('types.boo.constructor:', types.boo.constructor === Boolean); //truee
console.log('types.fnc.constructor:', types.fnc.constructor === Function); //truee
console.log('types.arr.constructor:', types.arr.constructor === Array); // true
console.log('types.obj.constructor:', types.obj.constructor === Object); //true
console.log('types.date.constructor:', types.date.constructor === Date); //true
