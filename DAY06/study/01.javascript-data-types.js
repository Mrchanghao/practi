...
// 문자 생성자 함수를 통해 숫자 객체를 생성하는 방법
var school_msg = new String('오늘 인터넷은 잘 터지나?'); //String{};
console.log(school_msg.valueOf());
// 숫자 생성자 함수를 통해 숫자 객체를 생성하는 방법
// function 생성자 함수를 통해 숫자 객체를 생성하는 방법
var eatRunch = new Function();
// 배열 생성자 함수를 통해 숫자 객체를 생성하는 방법
var favorite_collection = new Array('국자', '신발'); //Array{};
// ['국자', '신발'] 배열리터럴
// 객체 생성자 함수를 통해 숫자 객체를 생성하는 방법
...
// 변수 n1 선언 후 값으로 숫자 리터럴 99를 할당 
// 변수 n1 선언 후 숫자 값 99를 변수 n1에 복사. 
var n1 = 99;
//변수 k2를 선언 후 n1에 복사된 숫자 값 99를 복사한다
var k2 = n1;

// n1, k2에 복사된 숫자 데이터는 서로 다른 것이다. 
// n1의 데이터 값을 변경 하면 k2가 변화가 없어야 한다. 
...
// 학생 데이터 -> 10명 
var student_data = {
    student_1: { name: 'changhao', gender: 'male', age: 22, hobby: 'ski', school: '패스트캠퍼스', grade: 'first-month', major: 'economy', 부전공: 'chinese', family: { father: true, mother: true } },
    student_2: { name: 'jackson', gender: 'male', age: 22, hobby: '농구', school: '패스트캠퍼스', grade: 'first-month', major: 'economy', 부전공: '', family: { father: true, mother: true } },
    student_3: { name: 'mary', gender: 'fe-mail', age: 22, hobby: '축구', school: '패스트캠퍼스', grade: 'first-month', major: 'economy', 부전공: 'chinese', family: { father: true, mother: true } },
    student_4: { name: 'agnes', gender: 'fe-mail', age: 22, hobby: '수영', school: '패스트캠퍼스', grade: 'first-month', major: 'economy', 부전공: '', family: { father: true, mother: true } },
    student_5: { name: 'minam', gender: 'male', age: 22, hobby: '음악', school: '패스트캠퍼스', grade: 'first-month', major: 'economy', 부전공: '', family: { father: true, mother: true } },
    student_6: { name: 'danke', gender: 'male', age: 23, hobby: '', school: '패스트캠퍼스', grade: 'first-month', major: "music", 부전공: 'chinese', family: { father: true, mother: false } },
    student_7: { name: 'haoma', gender: 'male', age: 22, hobby: '컴퓨터', school: '패스트캠퍼스', grade: 'first-month', major: "music", 부전공: 'chinese', family: { father: true, mother: true, sister: true } },
    student_8: {
        name: 'zhendema',
        gender: 'male',
        age: 22,
        ...
        major: 'music',
        부전공: '',
        family: { father: true, mother: true, sister: true }
    },
    student_9: { name: 'fanle', gender: 'male', age: 24, hobby: '그림', school: '패스트캠퍼스', grade: 'first-month', major: 'economy', 부전공: 'chinese', family: { father: true, mother: true, brother: true } },
    student_10: { name: 'tama', gender: 'male', age: 22, hobby: '페스티벌', school: '패스트캠퍼스', grade: 'first-month', major: 'economy', 부전공: 'chinese', family: { father: true, mother: true, brother: true } }
};